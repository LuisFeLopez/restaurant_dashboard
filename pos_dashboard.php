...
<body>
    ...
    <div class="sidebar">
        <div class="menu-item <?php echo $current_section === 'mesas' ? 'active' : ''; ?>" onclick="changeSection('mesas')">
            <i class="fas fa-utensils"></i>
            <span>Gestión de Mesas</span>
        </div>
        <div class="menu-item <?php echo $current_section === 'pedidos' ? 'active' : ''; ?>" onclick="changeSection('pedidos')">
            <i class="fas fa-clipboard-list"></i>
            <span>Toma de Pedidos</span>
        </div>
        <div class="menu-item <?php echo $current_section === 'cocina' ? 'active' : ''; ?>" onclick="changeSection('cocina')">
            <i class="fas fa-concierge-bell"></i>
            <span>Cocina</span>
        </div>
        <div class="menu-item <?php echo $current_section === 'menu' ? 'active' : ''; ?>" onclick="changeSection('menu')">
            <i class="fas fa-book-open"></i>
            <span>Menú</span>
        </div>
        <div class="menu-item <?php echo $current_section === 'inventarios' ? 'active' : ''; ?>" onclick="changeSection('inventarios')">
            <i class="fas fa-boxes"></i>
            <span>Inventarios</span>
        </div>
        <div class="menu-item <?php echo $current_section === 'meseros' ? 'active' : ''; ?>" onclick="changeSection('meseros')">
            <i class="fas fa-user-friends"></i>
            <span>Meseros</span>
        </div>
        <div class="menu-item <?php echo $current_section === 'caja' ? 'active' : ''; ?>" onclick="changeSection('caja')">
            <i class="fas fa-cash-register"></i>
            <span>Caja</span>
        </div>
        <div class="menu-item <?php echo $current_section === 'reportes' ? 'active' : ''; ?>" onclick="changeSection('reportes')">
                ...
                <div class="grid">
                    ...
                    <?php else: ?>
                        <?php foreach ($section_data as $table): ?>
                            <div class="table-card <?php echo $table['status'] === 'occupied' ? 'occupied' : 'available'; ?>" onclick="manageTable(<?php echo $table['id']; ?>)">
                                <div class="table-number"><?php echo htmlspecialchars($table['table_number']); ?></div>
                                <div class="table-status"><?php echo $table['status'] === 'occupied' ? 'Ocupada' : 'Disponible'; ?></div>
                            </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </div>
                ...
                <div class="grid">
                    ...
                    <?php else: ?>
                        <?php foreach ($tables as $table): ?>
                            <div class="table-card <?php echo $table['status'] === 'occupied' ? 'occupied' : 'available'; ?>" onclick="newOrder(<?php echo $table['id']; ?>, '<?php echo htmlspecialchars($table['table_number']); ?>')">
                                <div class="table-number"><?php echo htmlspecialchars($table['table_number']); ?></div>
                                <div class="table-status"><?php echo $table['status'] === 'occupied' ? 'Ocupada' : 'Disponible'; ?></div>
                            </div>
                        <?php endforeach; ?>
                ...
                <?php else: ?>
                    <?php foreach ($section_data as $order): ?>
                        <div class="order-item">
                            <div class="order-header">
                                <strong>Pedido #<?php echo $order['id']; ?> - Mesa <?php echo htmlspecialchars($order['table_number']); ?></strong>
                                <button class="btn btn-success" onclick="updateOrderStatus(<?php echo $order['id']; ?>, 'ready')">Marcar Listo</button>
                            </div>
                            <p><strong>Mesero:</strong> <?php echo htmlspecialchars($order['user_name'] ?? 'N/A'); ?></p>
                            <p><strong>Hora:</strong> <?php echo date('H:i', strtotime($order['created_at'])); ?></p>
                        </div>
        ...
        <div class="modal-content" style="max-width: 800px;">
            ...
            <form method="POST" id="orderForm">
                ...
                <div class="form-group">
                    ...
                    <textarea id="order_notes" name="notes" rows="3" placeholder="Agregar notas adicionales al pedido..."></textarea>
                </div>
